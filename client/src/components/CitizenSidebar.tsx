...
import { LayoutDashboard, History, CreditCard, Settings, LogOut, ChevronLeft, ChevronRight, Building2 } from "lucide-react";
...
const links = [
  ...
  { to: "/citizen/properties", icon: Building2, label: "My Properties" },
  { to: "/citizen/history", icon: History, label: "Payment History" },
  { to: "/citizen/autopay", icon: CreditCard, label: "Auto Pay" },
        ...
        <AnimatePresence>
          {!collapsed && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col">
              ...
              <span className="text-sidebar-foreground/50 text-xs">Citizen Portal</span>
            </motion.div>
          )}
        </AnimatePresence>
